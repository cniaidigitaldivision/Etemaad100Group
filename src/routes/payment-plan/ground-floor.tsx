...
export const Route = createFileRoute("/payment-plan/ground-floor")({
  head: () => ({
    meta: [
      { title: "Ground Floor Payment Plan | GC Royal Emporium" },
    ],
  }),
...
].filter(p => !p.link.includes("ground-floor"));
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
            <Reveal>
              <div className="lux-card rounded-xl overflow-hidden shadow-2xl">
                <img src={shop2} alt="Ground Floor" className="w-full h-[450px] object-cover" />
              </div>
            </Reveal>
            <Reveal delay={0.2}>
              <div className="p-4 sm:p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between border-b border-border pb-4">
                    ...
                    <span className="font-semibold text-lg">PKR 40,000 – 45,000</span>
                  </div>
                  <div className="flex items-center justify-between border-b border-border pb-4">
                ...
                <p className="mt-8 text-muted-foreground leading-relaxed text-[15px]">
                  Ground Floor retail units provide maximum exposure and prestige. Featuring a double-height atrium feel and direct street-level access, these flagship spaces are perfectly suited for high-end fashion, jewelry, and global brands looking to make a statement.
                </p>
