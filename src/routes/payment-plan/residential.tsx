...
export const Route = createFileRoute("/payment-plan/residential")({
  head: () => ({
    meta: [
      { title: "Residential Apartments (7 Floors) Payment Plan | GC Royal Emporium" },
    ],
  }),
...
].filter(p => !p.link.includes("residential"));
          ...
          <div className="relative mx-auto max-w-7xl px-6 text-center">
            <Reveal>
              ...
              <h1 className="mt-4 font-display text-4xl leading-tight sm:text-5xl lg:text-6xl text-white">
                Residential Apartments (7 Floors)
              </h1>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
            <Reveal>
              <div className="lux-card rounded-xl overflow-hidden shadow-2xl">
                <img src={apt1} alt="Residential Apartments (7 Floors)" className="w-full h-[450px] object-cover" />
              </div>
            </Reveal>
            <Reveal delay={0.2}>
              <div className="p-4 sm:p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between border-b border-border pb-4">
                    ...
                    <span className="font-semibold text-lg">PKR 18,500</span>
                  </div>
                  <div className="flex items-center justify-between border-b border-border pb-4">
                  ...
                  <div className="flex items-center justify-between border-b border-border pb-4">
                    ...
                    <span className="font-semibold text-lg text-gold">PKR 60,000</span>
                  </div>
                  <div className="flex items-center justify-between border-b border-border pb-4">
                ...
                <p className="mt-8 text-muted-foreground leading-relaxed text-[15px]">
                  Elevate your living standards in our modern 1 and 2 bed apartments. Spanning seven dedicated floors, these residences offer stunning views, premium finishes, and exclusive access to community amenities, all just an elevator ride away from Chitral’s best shopping.
                </p>
