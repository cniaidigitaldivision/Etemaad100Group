...
export const Route = createFileRoute("/payment-plan/lower-ground")({
  head: () => ({
    meta: [
      { title: "Lower Ground Floor Payment Plan | GC Royal Emporium" },
    ],
  }),
...
].filter(p => !p.link.includes("lower-ground"));
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
            <Reveal>
              <div className="lux-card rounded-xl overflow-hidden shadow-2xl">
                <img src={shop1} alt="Lower Ground Floor" className="w-full h-[450px] object-cover" />
              </div>
            </Reveal>
            <Reveal delay={0.2}>
              <div className="p-4 sm:p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between border-b border-border pb-4">
                    ...
                    <span className="font-semibold text-lg">PKR 25,000 – 35,000</span>
                  </div>
                  <div className="flex items-center justify-between border-b border-border pb-4">
                ...
                <p className="mt-8 text-muted-foreground leading-relaxed text-[15px]">
                  The Lower Ground Floor offers prime retail positioning for brands seeking high footfall within the GC Royal Emporium. Designed with superior visibility and easy accessibility from the main entrances, these spaces ensure steady traffic and great commercial potential.
                </p>
